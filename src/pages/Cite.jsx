      ...
      <div className="cite-header">
        ...
        <div className="citation-header-box">
          <p className="citation-text">
            <strong>Evidence for Justice Lab. (2025). <em>The Justice and AI Tracker (JAI-T)</em>. McCourt School of Public Policy, Georgetown University. Retrieved from [URL]</strong>
          </p>
        </div>
      </div>
