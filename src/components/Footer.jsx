...
function Footer() {
  const linkedInUrl = "https://www.linkedin.com/company/evidence-for-justice-lab/"; // Replace with your actual LinkedIn URL
    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-right">
          ...
          <a 
            href="mailto:evidenceforjustice@georgetown.edu" 
            className="footer-email-link"
          >
            evidenceforjustice@georgetown.edu
          </a>
        </div>
